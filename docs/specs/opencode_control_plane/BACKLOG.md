...
| OCP-13 | Preserve review progress across bounded report retention | high | active | OCP-12 | review schema and skill | DBSCTR V3.13 contract | no | Keep pagination stable and expose independent cycle states | S | affected tests and deployment smoke |
