...
| OCP-11 | Add provider-neutral private DBSCTR review tools and command | high | in_progress | OCP-10 | review command, typed tools, permissions, tests | DBSCTR V3.11 contracts | no | Expose bounded review without general Plan writes | M | Config, contract, and fresh-process probes |
