...
| OCP-14 | Record structured OpenCode and advisory Herdr correlation | high | active | OCP-13 | typed begin and runtime adapter | DBSCTR V3.14 contract | no | Remove transcript identity heuristics without lifecycle coupling | M | focused tests and live runtime smoke |
