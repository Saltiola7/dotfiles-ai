...
| OCP-12 | Preserve immutable review snapshots through typed tools | high | doing | OCP-11 | review tool, runtime adapter, skill, tests | DBSCTR V3.12 contract | no | Prevent mutable pages and stale private completion | S | focused tests, build, deployed scan |
