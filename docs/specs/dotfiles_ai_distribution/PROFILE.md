...
| Runtime/platform support | Apple Silicon macOS; Fedora 44 aarch64 Lima guests on VZ; chezmoi; OpenCode; Herdr; launchd; Python `>=3.12` tests |
| Compatibility | Stable local TOML keys and managed target paths; sanitized defaults; pinned native release contracts |
