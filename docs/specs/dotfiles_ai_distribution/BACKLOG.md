...
|---|---|---|---|---|---|---|---|---|---|---|
| DAI-014 | Launch guest Herdr directly from workspace aliases and preserve Starship with Atuin | high | active | DAI-013 | Alias routing, Bash hook dispatcher, tests, and deployment evidence | Workspace alias and portable guest shell contracts | no | Routing and shell hooks share the deployed entry experience | S | Focused pytest, shell syntax, prompt/widget/history hooks, and live alias validation |
