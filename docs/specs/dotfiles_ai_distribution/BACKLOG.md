...
|---|---|---|---|
| DAI-017 | Protect main, retain published teammate feature baselines, and require verified draft-PR delivery with fresh reconciliation evidence | 2026-07-28 | `706711d..727f3bd` |
