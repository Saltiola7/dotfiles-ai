...
|---|---|---|---|---|---|---|---|---|---|---|
| DAI-017 | Require feature-branch Gate Commits and draft PR delivery into configured main | critical | in_progress | DAI-016 | Product Intent, delivery policy, teammate workflow, umbrella sequencing | DBSCTR lifecycle delivery and GitHub draft-PR contracts | no | Direct-to-main Final Push violates the approved contributor workflow and can bypass review | M | Focused lifecycle tests prove main is unchanged, teammate ahead commits remain baseline, dirty state fails closed, and a verified draft PR targets main |
