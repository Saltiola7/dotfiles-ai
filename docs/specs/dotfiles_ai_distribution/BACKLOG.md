...
|---|---|---|---|---|---|---|---|---|---|---|
| DAI-026 | Add automatic Vertex reauthentication alongside hosted fallback | high | active | DAI-025 | Browser helper, shared mode handling, tests, local deployment | Hosted Vertex reauthentication contract | no | Both commands renew one isolated ADC and must share security controls | S | Focused rendering/isolation tests, shell syntax, local apply |
