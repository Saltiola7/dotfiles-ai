...
|---|---|---|---|---|---|---|---|---|---|---|
| DAI-016 | Replace failed native scheduling with context-isolated Hermes orchestration | high | implementing | V3.31-1,OCP-29 | Hermes templates, profile reconciliation, sandbox propagation, scheduler retirement, distribution specs and tests | Existing scheduler ledger, canonical backlogs, Hermes v0.19 interfaces, configured workspace roots | no | Native scheduling has produced no successful autonomous outcome and Herdr ownership is crash-looping; Hermes must orchestrate without becoming lifecycle authority | XL | Host/client/personal profile isolation, backlog mirror, controlled refinement, gateway restart/reclaim, Herdr-independent Discovery, retirement and rollback |
