...
| V3.19-1 | Add private SQLite improvement ledger | high | in_progress | V3.17-1,V3.18-1 | Ledger schema, migrations, JSON compatibility, backup, restore | Private review history | no | Durable trends and experiments need transactional relational state | L | Migration, permissions, atomicity, integrity, backup, and restore tests |
