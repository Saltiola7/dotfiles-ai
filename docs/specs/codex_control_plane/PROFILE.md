...
| Runtime/platform support | Managed Codex CLI peer on Apple Silicon macOS, Fedora 44 aarch64 Lima guests, and CentOS Stream 10 x86_64 remote workspaces; private lock-selected stable release after body-free semantic compatibility validation |
